...
type CustomItemProps = { name: string, image: string, species: string, onPress: any }
    ...
    return (
        <SafeAreaView>
            <View>
                ...
                />
                <FlatList style={styles.characterList} data={characters}
                          keyExtractor={(item, index) => index.toString()} renderItem={
                ...
                />
                <Button title={'Previous'} disabled={loading || inputCharacterName != ""}
                        onPress={() => setPage((page - 1) < 0 ? page : page - 1)}/>
                <Button title={'Next'} disabled={loading || inputCharacterName != ""}
                        onPress={() => setPage((page + 1) > 25 ? page : page + 1)}/>
            </View>
        </SafeAreaView>
    );
};
